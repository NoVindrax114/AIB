...
#  print("".center(80, "*"))
 ...
 def diagnosis_1(self):
    global hasil
    hasil ="Anda butuh potongan daging neck"
#Rule 2
...
#Rule 3
 ...
 def diagnosis_3(self):
    global hasil
    hasil ="Anda butuh potongan daging brisket"
#Rule 4
...
#Rule 6
 ...
 def diagnosis_6(self):
    global hasil
    hasil ="Anda butuh potongan daging chuck"
#Rule 7
...
#Rule 8
 ...
 def diagnosis_8(self):
    global hasil
    hasil ="Anda butuh potongan daging tenderloin"
#Rule 9
 @Rule(Fact(Problem='daging'), (Fact(Q1='sup iga')))
 def diagnosis_9(self):
    global hasil
    hasil ="Anda butuh potongan daging rib"
#Rule 10
...
#Rule 12
 ...
 def diagnosis_12(self):
    global hasil
    hasil ="Anda butuh potongan daging sirloin"
#Rule 13
...
#Rule 14
 ...
 def diagnosis_14(self):
    global hasil
    hasil ="Anda butuh potongan daging short plate"
#Rule 15
...
#Rule 17
 ...
 def diagnosis_17(self):
    global hasil
    hasil ="Anda butuh potongan daging rump cap"
#Rule 18
...
#Rule 20
 ...
 def diagnosis_20(self):
    global hasil
    hasil ="Anda butuh potongan daging round"
#Rule 21
...
#Rule 23
 ...
 def diagnosis_23(self):
    global hasil
    hasil ="Anda butuh potongan daging pink slime"
#Rule 24
...
#Rule 25
 ...
 def diagnosis_25(self):
    global hasil
    hasil ="Anda butuh potongan daging shank"
#Rule 26
 @Rule(Fact(Problem='daging'), (Fact(Q1='kaldu')))
 def diagnosis_26(self):
    global hasil
    hasil ="Anda butuh potongan daging oxtail"
#Rule 27
...
#Rule 28
 ...
 def diagnosis_28(self):
    global hasil
    hasil = "Anda butuh potongan daging tongue"
#Rule 29
...
def get_daging(Problem_input, Q1_input):
    global hasil
    hasil=""
    engine = Loads()
    engine.reset()
    engine.declare(
        Fact(Problem = Problem_input), 
        Fact(Q1 = Q1_input))
    engine.run()
    return hasil

def get_masakan(Problem_input, Q1_input):
    global hasil
    hasil=""
    engine.reset()
    engine.declare(
